...
<hs:sec xmlns:hs="http://www.hancom.co.kr/hwpml/2011/section" xmlns:hp="http://www.hancom.co.kr/hwpml/2011/paragraph">
  <hp:p paraPrIDRef="0"><hp:run charPrIDRef="0"><hp:secPr><hp:startNum page="0"/><hp:visibility hideFirstPageNum="0"/><hp:pagePr width="10000" height="10000"><hp:margin left="1000" right="1000" top="1000" bottom="1000" header="300" footer="300"/></hp:pagePr><hp:pageNum pos="BOTTOM_CENTER" formatType="DIGIT" sideChar="-"/></hp:secPr><hp:header id="1" applyPageType="BOTH"><hp:subList><hp:p paraPrIDRef="0"><hp:run charPrIDRef="0"><hp:t>공개 머리말</hp:t></hp:run></hp:p></hp:subList></hp:header><hp:header id="4" applyPageType="EVEN"><hp:subList><hp:p paraPrIDRef="0"><hp:run charPrIDRef="0"><hp:t>짝수 쪽 머리말</hp:t></hp:run></hp:p></hp:subList></hp:header><hp:footer id="2" applyPageType="BOTH"><hp:subList><hp:p paraPrIDRef="0"><hp:run charPrIDRef="0"><hp:pic><hp:curSz width="200" height="200"/><hc:img xmlns:hc="http://www.hancom.co.kr/hwpml/2011/core" binaryItemIDRef="image1"/></hp:pic><hp:t>공개 꼬리말</hp:t></hp:run></hp:p></hp:subList></hp:footer><hp:tbl id="public-table" rowCnt="4" colCnt="1" pageBreak="CELL" repeatHeader="1"><hp:sz width="6000" height="7500"/>${cell(0, 1000, '공개 헤더', true)}${cell(1, 3000, '긴 설명')}${cell(2, 500, '다음 제목')}${cell(3, 3000, '다음 본문')}</hp:tbl></hp:run></hp:p>
</hs:sec>`
