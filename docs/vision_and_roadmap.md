...
`DocumentImporter`와 공통 IPC 성공·오류 계약으로 연결했고 과거 실패 전용 prototype은
제거했다. parser 역할은
...
2. 검증형 Save As 확인 UI와 제한된 IPC
3. 공개 identity fixture를 Windows 한/글에서 재열기
4. 문단·글자 style command 설계
