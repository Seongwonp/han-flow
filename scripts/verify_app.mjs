...
try {
  ...
  const failures = (expectedError ? [
    ...
    styleProbe && !state.editingProbe?.styleProbe?.italicApplied ? '기울임 style 적용 불일치' : undefined,
    styleProbe && !state.editingProbe?.styleProbe?.underlineApplied ? '밑줄 style 적용 불일치' : undefined,
    styleProbe && !state.editingProbe?.styleProbe?.strikeoutApplied ? '취소선 style 적용 불일치' : undefined,
